...
## [Camagru](https://github.com/JuhoKangas/42_camagru)
- A complete fullstack application built completely from ground up without any use of third party libraries
- Has complete user authentication and user management implemented
...
- Missing a readme but otherwise amazing piece of software
...
- as a bonus over 2000 lines of code to test the library
